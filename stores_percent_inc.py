...
def create_store_graph(provinces_file1, stores_file1, provinces_file2, stores_file2):
	...
	# Plot the absolute number increase in store counts
	ax.bar(r1, number_increase[provinces], color='skyblue', width=bar_width)
	...
	ax.set_ylabel('Number Increase')
	ax.set_title('Number Increase in Stores from 2017 to 2023')
